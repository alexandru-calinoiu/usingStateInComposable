...
fun TodoItemInlineEditor(
        ...
        text = todoItem.task,
        onTextChange = { onEditItemChange(todoItem.copy(task = it)) },
        icon = todoItem.icon,
        onIconChange = { onEditItemChange(todoItem.copy(icon = it)) },
        submit = onEditDone,
        iconsVisible = true
) {
    Row {
